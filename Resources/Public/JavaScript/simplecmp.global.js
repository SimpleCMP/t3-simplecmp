...
`,title:"\u6027\u80FD\u4F18\u5316"}},save:"\u633D\u6551",service:{disableAll:{description:"\u4F7F\u7528\u6B64\u5F00\u5173\u53EF\u542F\u7528\u6216\u7981\u7528\u6240\u6709\u670D\u52A1\u3002",title:"\u542F\u7528\u6216\u505C\u7528\u6240\u6709\u670D\u52A1"},optOut:{description:"\u8FD9\u4E2A\u670D\u52A1\u662F\u9ED8\u8BA4\u52A0\u8F7D\u7684(\u4F46\u4F60\u53EF\u4EE5\u9009\u62E9\u9000\u51FA)",title:"(\u9009\u62E9\u9000\u51FA)"},purpose:"\u76EE\u7684",purposes:"\u76EE\u7684",required:{description:"\u8FD9\u79CD\u670D\u52A1\u662F\u5FC5\u987B\u7684",title:"(\u603B\u662F\u9700\u8981)"}}};var sr={bg:Bt,ca:Ht,cs:qt,da:Ft,de:Vt,el:Wt,en:Kt,es:Gt,fi:Qt,fr:Zt,gl:Jt,hr:Xt,hu:Yt,it:ei,nl:ti,no:ii,oc:ni,pl:ri,pt:oi,ro:si,ru:ai,sr:ci,sr_cyrl:li,sv:pi,tr:di,zh:ui},mi=sr;function _e(r,e,t){if(typeof e=="string"){if(e.length>=2&&e.startsWith("/")&&e.endsWith("/"))try{return new RegExp(e.slice(1,-1)).test(r)}catch{return!1}return e===r}if(e instanceof RegExp)return e.test(r);if(Array.isArray(e)&&e.length>0){let i=e[0];if(typeof i!="string")return!1;try{return new RegExp(i).test(r)}catch{return i===r}}return typeof e=="object"&&e!==null&&"name"in e&&"requireOrigin"in e&&ar(e.requireOrigin,t)?_e(r,e.name,t):!1}function Ce(r,e){if(e instanceof RegExp)return e.test(r);if(typeof e!="string")return!1;if(e.length>=2&&e.startsWith("/")&&e.endsWith("/"))try{return new RegExp(`^(?:${e.slice(1,-1)})$`).test(r)}catch{return!1}if(e.startsWith("*.")){let t=e.slice(2);return r===t||r.endsWith(`.${t}`)}return e===r}function ar(r,e){for(let t of e)if(Ce(t,r))return!0;return!1}var W=class{constructor(e){this.services=e;this.observedOrigins=new Set}classify(e){e.kind!=="cookie"&&e.origin&&this.observedOrigins.add(e.origin);let t=this._findService(e);return t?{matchedService:t,status:"known"}:{status:"unknown"}}hasObservedOrigin(e){return this.observedOrigins.has(e)}get observedOriginsView(){return this.observedOrigins}_findService(e){if(e.kind==="cookie"){for(let t of this.services)if(t.cookies){for(let i of t.cookies)if(_e(e.identifier,i,this.observedOrigins))return t.name}return}if(e.origin){for(let t of this.services)if(t.origins){for(let i of t.origins)if(Ce(e.origin,i))return t.name}}}};var cr="simplecmp.recorder.";function fi(r){return!!(!r||r==="localhost"||r.endsWith(".localhost")||r.endsWith(".local")||r.endsWith(".test")||/^127\.\d+\.\d+\.\d+$/.test(r)||/^192\.168\.\d+\.\d+$/.test(r)||/^10\.\d+\.\d+\.\d+$/.test(r)||r==="::1"||r==="0.0.0.0")}var Ae=class{constructor(e){this.listeners=new Set;this.settledListeners=new Set;this.detections=new Map;this.active=!1;this.options=e.options,this.classifier=e.classifier,this.services=e.services,this.onDetectionForLibEvent=e.onDetectionForLibEvent;let t=i=>this._ingest(i);this.watchers=e.watcherFactories.map(i=>i(t))}start(){if(this.active)return;this.active=!0;let e=typeof location<"u"?location.hostname:"",t=fi(e);!t&&!this.options.silenceProductionWarning&&console.warn(`SimpleCMP: recorder is active on a hostname that looks like production (${e||"unknown"}). Set \`record: { silenceProductionWarning: true }\` to suppress this warning if intentional.`),this.options.persistInDev&&t&&this._loadFromStorage();for(let n of this.watchers)n.start();let i=this.options.summaryIntervalMs??3e4;i>0&&typeof setInterval<"u"&&(this.summaryTimer=setInterval(()=>this._logSummary(),i))}stop(){if(this.active){this.active=!1;for(let e of this.watchers)e.stop();this.summaryTimer!==void 0&&(clearInterval(this.summaryTimer),this.summaryTimer=void 0)}}getSnapshot(){return Array.from(this.detections.values())}clear(){this.detections.clear(),this._writeToStorage()}on(e,t){e==="detection"?this.listeners.add(t):e==="detectionSettled"&&this.settledListeners.add(t)}off(e,t){e==="detection"?this.listeners.delete(t):e==="detectionSettled"&&this.settledListeners.delete(t)}recordSyntheticDetection(e){this.active&&this._ingest(e)}enrichDetection(e,t){let i=`${e.kind}:${e.identifier}`,n=this.detections.get(i);if(!n)return;let o={...n,...t,lastSeen:Date.now()};this.detections.set(i,o),this._announce(o),this._writeToStorage()}exportConfig(){let e=new Map;for(let i of this.services){let n={name:i.name};i.cookies&&(n.cookies=i.cookies.slice()),i.origins&&(n.origins=i.origins.slice()),e.set(i.name,n)}let t=1;for(let i of this.detections.values()){if(i.status!=="unknown")continue;let n=i.kind==="cookie"?`unknown-cookie-${t++}`:`unknown-${i.origin?.replace(/[^a-z0-9]+/gi,"-")??"origin"}-${t++}`,o={name:n,purposes:[]};i.kind==="cookie"?o.cookies=[i.identifier]:i.origin&&(o.origins=[i.origin]),e.set(n,o)}return{services:Array.from(e.values())}}assertNoUnknown(){let e=this.getSnapshot().filter(i=>i.status==="unknown");if(e.length===0)return;let t=e.map(i=>`  - [${i.kind}] ${i.identifier}${i.origin?` (${i.origin})`:""}`).join(`
`);throw new Error(`SimpleCMP recorder: ${e.length} unknown detection(s):
${t}
Add a service for each, or pass \`record: { silenceProductionWarning: true }\` if intentional.`)}_ingest(e){if(e.kind==="cookie"&&this.options.ignoreCookies?.includes(e.identifier))return;let t=`${e.kind}:${e.identifier}`,i=Date.now(),n=this.detections.get(t);if(n){n.lastSeen=i,n.count+=1;return}let o=this.classifier.classify(e),{pending:s,...a}=o,c={kind:e.kind,identifier:e.identifier,origin:e.origin,firstSeen:i,lastSeen:i,firstSeenOn:e.firstSeenOn,count:1,...a};this.detections.set(t,c),this._announce(c),this._writeToStorage(),e.kind!=="cookie"&&e.origin&&this._reclassifyUnknownCookiesOnNewOrigin(),s?s.finally(()=>this._announceSettled(t)):this._announceSettled(t)}_announce(e){typeof console<"u"&&typeof console.info=="function"&&console.info(`[SimpleCMP recorder] ${e.kind} ${e.status==="unknown"?"\u{1F7E1} unknown":`\u2192 ${e.matchedService}`}: ${e.identifier}`);for(let t of[...this.listeners])try{t(e)}catch(i){console.warn("SimpleCMP recorder: listener threw:",i)}if(this.onDetectionForLibEvent)try{this.onDetectionForLibEvent(e)}catch(t){console.warn("SimpleCMP recorder: lib-event handler threw:",t)}}_reclassifyUnknownCookiesOnNewOrigin(){for(let e of this.detections.values()){if(e.kind!=="cookie"||e.status!=="unknown")continue;let t=this.classifier.classify({kind:e.kind,identifier:e.identifier,origin:e.origin,firstSeenOn:e.firstSeenOn});if(t.status==="known"&&t.matchedService){let i={status:"known",matchedService:t.matchedService};t.matchedVendor!==void 0&&(i.matchedVendor=t.matchedVendor),this.enrichDetection({kind:e.kind,identifier:e.identifier},i)}}}_announceSettled(e){let t=this.detections.get(e);if(t)for(let i of[...this.settledListeners])try{i(t)}catch(n){console.warn("SimpleCMP recorder: settled listener threw:",n)}}_logSummary(){if(this.detections.size===0)return;let e=Array.from(this.detections.values()).map(t=>({kind:t.kind,identifier:t.identifier,origin:t.origin??"",status:t.status,service:t.matchedService??"",count:t.count,firstSeenOn:t.firstSeenOn??""}));typeof console.table=="function"&&(console.groupCollapsed("[SimpleCMP recorder] catalog"),console.table(e),console.groupEnd())}_storageKey(){return cr+(this.options.storageName??"default")}_loadFromStorage(){if(!(typeof sessionStorage>"u"))try{let e=sessionStorage.getItem(this._storageKey());if(!e)return;let t=JSON.parse(e);if(t.schema!==1||!Array.isArray(t.detections))return;for(let i of t.detections)this.detections.set(`${i.kind}:${i.identifier}`,i)}catch{}}_writeToStorage(){if(this.options.persistInDev&&!(typeof location>"u"||!fi(location.hostname))&&!(typeof sessionStorage>"u"))try{let e=JSON.stringify({schema:1,detections:Array.from(this.detections.values())});sessionStorage.setItem(this._storageKey(),e)}catch{}}};function lr(r){let e=new Set;if(!r)return e;for(let t of r.split(";")){let i=t.indexOf("="),n=(i>=0?t.slice(0,i):t).trim();n&&e.add(n)}return e}var xe=class{constructor(e,t={}){this.seen=new Set;this.sink=e,this.intervalMs=t.intervalMs??1e3,this.readCookies=t.readCookies??(()=>typeof document<"u"?document.cookie:""),this.getPathname=()=>typeof location<"u"?location.pathname+location.search:void 0}start(){this.timerId===void 0&&(this._scan(),this.timerId=setInterval(()=>this._scan(),this.intervalMs))}stop(){this.timerId!==void 0&&(clearInterval(this.timerId),this.timerId=void 0)}scanOnce(){this._scan()}_scan(){let e=lr(this.readCookies()),t=this.getPathname();for(let i of e)this.seen.has(i)||(this.seen.add(i),this.sink({kind:"cookie",identifier:i,firstSeenOn:t}))}};var Xe={SCRIPT:"script",IFRAME:"iframe",IMG:"image",LINK:"link",AUDIO:"request",VIDEO:"request",SOURCE:"request",TRACK:"request",EMBED:"request",OBJECT:"request"};function pr(r){let e=r.tagName;if(e==="LINK")return r.href||void 0;if(e==="OBJECT")return r.data||void 0;let t=r.getAttribute("src");if(t)try{return new URL(t,location.href).href}catch{return}}function dr(r){try{return new URL(r).hostname}catch{return}}var Ee=class{constructor(e,t={}){this.seen=new Set;this.sink=e,this.root=t.root??(typeof document<"u"?document.documentElement:null)}start(){!this.root||this.observer||(this._initialScan(),!(typeof MutationObserver>"u")&&(this.observer=new MutationObserver(e=>this._onMutations(e)),this.observer.observe(this.root,{childList:!0,subtree:!0})))}stop(){this.observer&&(this.observer.disconnect(),this.observer=void 0)}_initialScan(){if(!this.root)return;let e=Object.keys(Xe).join(","),t=this.root.querySelectorAll(e);for(let i of Array.from(t))this._handleElement(i)}_onMutations(e){for(let t of e)for(let i of Array.from(t.addedNodes)){if(i.nodeType!==1)continue;let n=i;if(this._handleElement(n),n.querySelectorAll){let o=Object.keys(Xe).join(",");for(let s of Array.from(n.querySelectorAll(o)))this._handleElement(s)}}}_handleElement(e){let t=Xe[e.tagName];if(!t)return;let i=pr(e);if(!i)return;let n=dr(i);if(!n||typeof location<"u"&&n===location.hostname)return;let o=`${t}:${i}`;if(this.seen.has(o))return;this.seen.add(o);let s={kind:t,identifier:i,origin:n,firstSeenOn:typeof location<"u"?location.pathname+location.search:void 0};this.sink(s)}};function ur(r){try{return new URL(r).hostname}catch{return}}var ze=class{constructor(e,t={}){this.seen=new Set;this.sink=e,this.perf=t.performance??(typeof performance<"u"?performance:void 0),this.Observer=t.PerformanceObserver??(typeof PerformanceObserver<"u"?PerformanceObserver:void 0)}start(){if(!this.observer&&(this._drainExisting(),!!this.Observer))try{this.observer=new this.Observer(e=>this._handleList(e)),this.observer.observe({type:"resource",buffered:!1})}catch{try{this.observer=new this.Observer(e=>this._handleList(e)),this.observer.observe({entryTypes:["resource"]})}catch{this.observer=void 0}}}stop(){this.observer&&(this.observer.disconnect(),this.observer=void 0)}_drainExisting(){if(this.perf)try{let e=this.perf.getEntriesByType("resource");for(let t of e)this._handleEntry(t)}catch{}}_handleList(e){for(let t of e.getEntries())this._handleEntry(t)}_handleEntry(e){let t=e.name;if(!t)return;let i=ur(t);if(!i||typeof location<"u"&&i===location.hostname)return;let n=`request:${t}`;if(this.seen.has(n))return;this.seen.add(n);let o={kind:"request",identifier:t,origin:i,firstSeenOn:typeof location<"u"?location.pathname+location.search:void 0};this.sink(o)}};function hi(r){let e={matcher:r.matcher,consentChecker:r.consentChecker,sameOriginHosts:[window.location.host,...r.sameOriginHosts??[]],onBlock:r.onBlock??(()=>{})},t=[Ye(HTMLScriptElement.prototype,"script-src",e),Ye(HTMLIFrameElement.prototype,"iframe-src",e),Ye(HTMLImageElement.prototype,"img-src",e),mr(e),fr(e),hr(e)];return()=>{for(let i of t)i()}}function $e(r,e){if(!r||r==="about:blank")return null;let t;try{t=new URL(r,window.location.href)}catch{return null}let{host:i,hostname:n}=t;if(i===""||e.sameOriginHosts.includes(i))return null;let o=e.matcher(n);return o===null||e.consentChecker(o)?null:o}function Ye(r,e,t){let i=Object.getOwnPropertyDescriptor(r,"src");if(!i?.get||!i?.set)return()=>{};let n=i.set;return Object.defineProperty(r,"src",{configurable:!0,enumerable:i.enumerable,get:i.get,set(o){let s=this.getAttribute?.("data-name");if(s!=null&&t.consentChecker(s)===!0){n.call(this,o);return}let a=$e(o,t);if(a!==null){t.onBlock({mechanism:e,url:o,service:a});return}n.call(this,o)}}),()=>Object.defineProperty(r,"src",i)}function mr(r){if(typeof window.fetch!="function")return()=>{};let e=window.fetch.bind(window);return window.fetch=function(i,n){let o;typeof i=="string"?o=i:i instanceof URL?o=i.href:o=i.url;let s=$e(o,r);return s!==null?(r.onBlock({mechanism:"fetch",url:o,service:s}),Promise.reject(new TypeError(`SimpleCMP: consent for ${s} not granted`))):e(i,n)},()=>{window.fetch=e}}function fr(r){let e=XMLHttpRequest.prototype.open,t=XMLHttpRequest.prototype.send,i="__simplecmpBlockedService";return XMLHttpRequest.prototype.open=function(o,s,...a){let c=this;c[i]!==void 0&&delete c[i];let l=typeof s=="string"?s:s.href,f=$e(l,r);f!==null&&(r.onBlock({mechanism:"xhr",url:l,service:f}),c[i]=f),e.call(this,o,s,...a)},XMLHttpRequest.prototype.send=function(o){this[i]===void 0&&t.call(this,o)},()=>{XMLHttpRequest.prototype.open=e,XMLHttpRequest.prototype.send=t}}function hr(r){if(typeof navigator.sendBeacon!="function")return()=>{};let e=navigator.sendBeacon.bind(navigator);return navigator.sendBeacon=function(i,n){let o=typeof i=="string"?i:i.href,s=$e(o,r);return s!==null?(r.onBlock({mechanism:"sendBeacon",url:o,service:s}),!1):e(i,n)},()=>{navigator.sendBeacon=e}}function gi(r,e={}){let t=r.filter(n=>Array.isArray(n.origins)&&n.origins.length>0).map(n=>({name:n.name,origins:n.origins})),i=e.blockAllUnknown===!0;return n=>{if(n==="")return null;for(let o of t)for(let s of o.origins)if(Ce(n,s))return o.name;return i?n:null}}var vi="simplecmp.servicedb.";function et(r,e){let t=e.cookie?`c:${e.cookie}`:`o:${e.origin??""}`;return`${vi}${r}.${t}`}function gr(r,e){let t=r.get("Cache-Control");if(!t)return e;let i=/max-age=(\d+)/.exec(t);if(!i||!i[1])return e;let n=Number.parseInt(i[1],10);return Number.isNaN(n)||n<0?e:n*1e3}var K=class{constructor(e){this.inflight=new Map;this.warned=new Set;this.url=e.url.replace(/\/+$/,""),this.host=(()=>{try{return new URL(this.url).host}catch{return this.url}})(),this.auth=e.auth,this.cacheTtlMs=e.cacheTtlMs??864e5,this.timeoutMs=e.timeoutMs??3e3,this.apiVersion=e.apiVersion??"v1",this.fetchFn=e.fetch??(typeof fetch<"u"?fetch.bind(globalThis):void 0),this.storage=e.storage??(typeof localStorage<"u"?localStorage:void 0),this.now=e.now??(()=>Date.now())}async lookup(e){let t=et(this.host,e),i=this._readCache(t);return i!==void 0?(this.now()-i.storedAt<i.maxAgeMs||this._revalidate(t,e),i.match):this._fetchAndCache(t,e)}async lookupBatch(e){if(e.length===0)return[];let t=new Array(e.length).fill(void 0),i=[];for(let n=0;n<e.length;n++){let o=e[n];if(!o)continue;let s=et(this.host,o),a=this._readCache(s);a!==void 0&&this.now()-a.storedAt<a.maxAgeMs?t[n]=a.match:i.push({index:n,query:o})}if(i.length===0)return t.map(n=>n??null);try{let n=JSON.stringify({items:i.map(a=>a.query)}),s=(await this._request(`/${this.apiVersion}/lookup`,{method:"POST",headers:{"Content-Type":"application/json"},body:n}))?.items??[];for(let a=0;a<i.length;a++){let c=i[a],l=s[a];if(!c)continue;let f=l?.matches?.[0]??null,m=et(this.host,c.query);this._writeCache(m,f,this.cacheTtlMs),t[c.index]=f}}catch(n){this._warnOnce("batch-lookup",n);for(let o of i)t[o.index]=null}return t.map(n=>n??null)}clearCache(){if(!this.storage)return;let e=this.storage;if(typeof e.length!="number"||typeof e.key!="function")return;let t=`${vi}${this.host}.`,i=[];for(let n=0;n<e.length;n++){let o=e.key(n);o?.startsWith(t)&&i.push(o)}for(let n of i)this.storage.removeItem(n)}async health(){try{return await this._request(`/${this.apiVersion}/health`,{method:"GET"})}catch{return null}}async _fetchAndCache(e,t){let i=this.inflight.get(e);if(i)return i;let n=(async()=>{try{let s=(await this._request(`/${this.apiVersion}/lookup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({items:[t]})}))?.items?.[0]?.matches?.[0]??null;return this._writeCache(e,s,this.cacheTtlMs),s}catch(o){return this._warnOnce("lookup",o),null}finally{this.inflight.delete(e)}})();return this.inflight.set(e,n),n}async _revalidate(e,t){this.inflight.has(e)||await this._fetchAndCache(e,t).catch(()=>{})}async _request(e,t){if(!this.fetchFn)throw new Error("fetch is unavailable");let i=new Headers(t.headers);if(this.auth){let s=this.auth.header??"Authorization",a=this.auth.scheme??"Bearer";i.set(s,`${a} ${this.auth.token}`.trim())}let n=typeof AbortController<"u"?new AbortController:null,o=n&&typeof setTimeout<"u"?setTimeout(()=>n.abort(),this.timeoutMs):void 0;try{let s=await this.fetchFn(`${this.url}${e}`,{...t,headers:i,signal:n?.signal});if(!s.ok)throw new Error(`Service DB ${e} responded ${s.status}`);return await s.json()}finally{o!==void 0&&clearTimeout(o)}}_readCache(e){if(this.storage)try{let t=this.storage.getItem(e);if(!t)return;let i=JSON.parse(t);return typeof i.storedAt!="number"||typeof i.maxAgeMs!="number"?void 0:i}catch{return}}_writeCache(e,t,i){if(this.storage)try{let n={match:t,storedAt:this.now(),maxAgeMs:i};this.storage.setItem(e,JSON.stringify(n))}catch{}}_absorbCacheControl(e){return gr(e,this.cacheTtlMs)}_warnOnce(e,t){if(this.warned.has(e))return;this.warned.add(e);let i=t instanceof Error?t.message:String(t);console.warn(`SimpleCMP service-db: ${e} failed (${i}). Falling back to local classification for this session category.`)}};var G=class{constructor(e,t){this.dbClient=e;this.listeners=new Set;this.local=new W(t)}classify(e){let t=this.local.classify(e);if(t.status==="known")return t;let i=e.kind==="cookie"?{cookie:e.identifier}:e.origin?{origin:e.origin}:null;if(!i)return t;let n=this.dbClient.lookup(i).then(o=>{o&&(e.kind==="cookie"&&!this._hostQualifierPasses(o,e.identifier)||this._dispatch(e,this._toEnrichment(o)))}).catch(()=>{});return{...t,pending:n}}_hostQualifierPasses(e,t){let i=e.matches?.cookies??[];if(i.length===0)return!0;let n=this.local.observedOriginsView;for(let o of i)if(_e(t,o,n))return!0;return!1}onEnrichment(e){this.listeners.add(e)}offEnrichment(e){this.listeners.delete(e)}_dispatch(e,t){for(let i of this.listeners)try{i(e,t)}catch(n){console.warn("SimpleCMP service-db: enrichment listener threw:",n)}}_toEnrichment(e){return{matchedService:e.id,matchedVendor:e.vendor,status:"known"}}};var Me=globalThis,Pe=Me.ShadowRoot&&(Me.ShadyCSS===void 0||Me.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,tt=Symbol(),yi=new WeakMap,oe=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==tt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Pe&&e===void 0){let i=t!==void 0&&t.length===1;i&&(e=yi.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&yi.set(t,e))}return e}toString(){return this.cssText}},bi=r=>new oe(typeof r=="string"?r:r+"",void 0,tt),y=(r,...e)=>{let t=r.length===1?r[0]:e.reduce((i,n,o)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+r[o+1],r[0]);return new oe(t,r,tt)},ki=(r,e)=>{if(Pe)r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let i=document.createElement("style"),n=Me.litNonce;n!==void 0&&i.setAttribute("nonce",n),i.textContent=t.cssText,r.appendChild(i)}},it=Pe?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(let i of e.cssRules)t+=i.cssText;return bi(t)})(r):r;var{is:vr,defineProperty:yr,getOwnPropertyDescriptor:br,getOwnPropertyNames:kr,getOwnPropertySymbols:wr,getPrototypeOf:Sr}=Object,$=globalThis,wi=$.trustedTypes,_r=wi?wi.emptyScript:"",Cr=$.reactiveElementPolyfillSupport,se=(r,e)=>r,ae={toAttribute(r,e){switch(e){case Boolean:r=r?_r:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},Te=(r,e)=>!vr(r,e),Si={attribute:!0,type:String,converter:ae,reflect:!1,useDefault:!1,hasChanged:Te};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),$.litPropertyMetadata??($.litPropertyMetadata=new WeakMap);var C=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Si){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let i=Symbol(),n=this.getPropertyDescriptor(e,i,t);n!==void 0&&yr(this.prototype,e,n)}}static getPropertyDescriptor(e,t,i){let{get:n,set:o}=br(this.prototype,e)??{get(){return this[t]},set(s){this[t]=s}};return{get:n,set(s){let a=n?.call(this);o?.call(this,s),this.requestUpdate(e,a,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Si}static _$Ei(){if(this.hasOwnProperty(se("elementProperties")))return;let e=Sr(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(se("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(se("properties"))){let t=this.properties,i=[...kr(t),...wr(t)];for(let n of i)this.createProperty(n,t[n])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[i,n]of t)this.elementProperties.set(i,n)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let n=this._$Eu(t,i);n!==void 0&&this._$Eh.set(n,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let i=new Set(e.flat(1/0).reverse());for(let n of i)t.unshift(it(n))}else e!==void 0&&t.push(it(e));return t}static _$Eu(e,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ki(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){let i=this.constructor.elementProperties.get(e),n=this.constructor._$Eu(e,i);if(n!==void 0&&i.reflect===!0){let o=(i.converter?.toAttribute!==void 0?i.converter:ae).toAttribute(t,i.type);this._$Em=e,o==null?this.removeAttribute(n):this.setAttribute(n,o),this._$Em=null}}_$AK(e,t){let i=this.constructor,n=i._$Eh.get(e);if(n!==void 0&&this._$Em!==n){let o=i.getPropertyOptions(n),s=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:ae;this._$Em=n;let a=s.fromAttribute(t,o.type);this[n]=a??this._$Ej?.get(n)??a,this._$Em=null}}requestUpdate(e,t,i,n=!1,o){if(e!==void 0){let s=this.constructor;if(n===!1&&(o=this[e]),i??(i=s.getPropertyOptions(e)),!((i.hasChanged??Te)(o,t)||i.useDefault&&i.reflect&&o===this._$Ej?.get(e)&&!this.hasAttribute(s._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:n,wrapped:o},s){i&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,s??t??this[e]),o!==!0||s!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),n===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(let[n,o]of this._$Ep)this[n]=o;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[n,o]of i){let{wrapped:s}=o,a=this[n];s!==!0||this._$AL.has(n)||a===void 0||this.C(n,void 0,o,a)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw e=!1,this._$EM(),i}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};C.elementStyles=[],C.shadowRootOptions={mode:"open"},C[se("elementProperties")]=new Map,C[se("finalized")]=new Map,Cr?.({ReactiveElement:C}),($.reactiveElementVersions??($.reactiveElementVersions=[])).push("2.1.2");var le=globalThis,_i=r=>r,De=le.trustedTypes,Ci=De?De.createPolicy("lit-html",{createHTML:r=>r}):void 0,Mi="$lit$",M=`lit$${Math.random().toFixed(9).slice(2)}$`,Pi="?"+M,Ar=`<${Pi}>`,U=document,pe=()=>U.createComment(""),de=r=>r===null||typeof r!="object"&&typeof r!="function",lt=Array.isArray,xr=r=>lt(r)||typeof r?.[Symbol.iterator]=="function",nt=`[ 	
\f\r]`,ce=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ai=/-->/g,xi=/>/g,I=RegExp(`>|${nt}(?:([^\\s"'>=/]+)(${nt}*=${nt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ei=/'/g,zi=/"/g,Ti=/^(?:script|style|textarea|title)$/i,pt=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),u=pt(1),aa=pt(2),ca=pt(3),A=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),$i=new WeakMap,N=U.createTreeWalker(U,129);function Di(r,e){if(!lt(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ci!==void 0?Ci.createHTML(e):e}var Er=(r,e)=>{let t=r.length-1,i=[],n,o=e===2?"<svg>":e===3?"<math>":"",s=ce;for(let a=0;a<t;a++){let c=r[a],l,f,m=-1,d=0;for(;d<c.length&&(s.lastIndex=d,f=s.exec(c),f!==null);)d=s.lastIndex,s===ce?f[1]==="!--"?s=Ai:f[1]!==void 0?s=xi:f[2]!==void 0?(Ti.test(f[2])&&(n=RegExp("</"+f[2],"g")),s=I):f[3]!==void 0&&(s=I):s===I?f[0]===">"?(s=n??ce,m=-1):f[1]===void 0?m=-2:(m=s.lastIndex-f[2].length,l=f[1],s=f[3]===void 0?I:f[3]==='"'?zi:Ei):s===zi||s===Ei?s=I:s===Ai||s===xi?s=ce:(s=I,n=void 0);let g=s===I&&r[a+1].startsWith("/>")?" ":"";o+=s===ce?c+Ar:m>=0?(i.push(l),c.slice(0,m)+Mi+c.slice(m)+M+g):c+M+(m===-2?a:g)}return[Di(r,o+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},ue=class r{constructor({strings:e,_$litType$:t},i){let n;this.parts=[];let o=0,s=0,a=e.length-1,c=this.parts,[l,f]=Er(e,t);if(this.el=r.createElement(l,i),N.currentNode=this.el.content,t===2||t===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(n=N.nextNode())!==null&&c.length<a;){if(n.nodeType===1){if(n.hasAttributes())for(let m of n.getAttributeNames())if(m.endsWith(Mi)){let d=f[s++],g=n.getAttribute(m).split(M),_=/([.?@])?(.*)/.exec(d);c.push({type:1,index:o,name:_[2],strings:g,ctor:_[1]==="."?ot:_[1]==="?"?st:_[1]==="@"?at:Z}),n.removeAttribute(m)}else m.startsWith(M)&&(c.push({type:6,index:o}),n.removeAttribute(m));if(Ti.test(n.tagName)){let m=n.textContent.split(M),d=m.length-1;if(d>0){n.textContent=De?De.emptyScript:"";for(let g=0;g<d;g++)n.append(m[g],pe()),N.nextNode(),c.push({type:2,index:++o});n.append(m[d],pe())}}}else if(n.nodeType===8)if(n.data===Pi)c.push({type:2,index:o});else{let m=-1;for(;(m=n.data.indexOf(M,m+1))!==-1;)c.push({type:7,index:o}),m+=M.length-1}o++}}static createElement(e,t){let i=U.createElement("template");return i.innerHTML=e,i}};function Q(r,e,t=r,i){if(e===A)return e;let n=i!==void 0?t._$Co?.[i]:t._$Cl,o=de(e)?void 0:e._$litDirective$;return n?.constructor!==o&&(n?._$AO?.(!1),o===void 0?n=void 0:(n=new o(r),n._$AT(r,t,i)),i!==void 0?(t._$Co??(t._$Co=[]))[i]=n:t._$Cl=n),n!==void 0&&(e=Q(r,n._$AS(r,e.values),n,i)),e}var rt=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,n=(e?.creationScope??U).importNode(t,!0);N.currentNode=n;let o=N.nextNode(),s=0,a=0,c=i[0];for(;c!==void 0;){if(s===c.index){let l;c.type===2?l=new me(o,o.nextSibling,this,e):c.type===1?l=new c.ctor(o,c.name,c.strings,this,e):c.type===6&&(l=new ct(o,this,e)),this._$AV.push(l),c=i[++a]}s!==c?.index&&(o=N.nextNode(),s++)}return N.currentNode=U,n}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},me=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,n){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Q(this,e,t),de(e)?e===p||e==null||e===""?(this._$AH!==p&&this._$AR(),this._$AH=p):e!==this._$AH&&e!==A&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):xr(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==p&&de(this._$AH)?this._$AA.nextSibling.data=e:this.T(U.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=ue.createElement(Di(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(t);else{let o=new rt(n,this),s=o.u(this.options);o.p(t),this.T(s),this._$AH=o}}_$AC(e){let t=$i.get(e.strings);return t===void 0&&$i.set(e.strings,t=new ue(e)),t}k(e){lt(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,n=0;for(let o of e)n===t.length?t.push(i=new r(this.O(pe()),this.O(pe()),this,this.options)):i=t[n],i._$AI(o),n++;n<t.length&&(this._$AR(i&&i._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=_i(e).nextSibling;_i(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Z=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,n,o){this.type=1,this._$AH=p,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=p}_$AI(e,t=this,i,n){let o=this.strings,s=!1;if(o===void 0)e=Q(this,e,t,0),s=!de(e)||e!==this._$AH&&e!==A,s&&(this._$AH=e);else{let a=e,c,l;for(e=o[0],c=0;c<o.length-1;c++)l=Q(this,a[i+c],t,c),l===A&&(l=this._$AH[c]),s||(s=!de(l)||l!==this._$AH[c]),l===p?e=p:e!==p&&(e+=(l??"")+o[c+1]),this._$AH[c]=l}s&&!n&&this.j(e)}j(e){e===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ot=class extends Z{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===p?void 0:e}},st=class extends Z{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==p)}},at=class extends Z{constructor(e,t,i,n,o){super(e,t,i,n,o),this.type=5}_$AI(e,t=this){if((e=Q(this,e,t,0)??p)===A)return;let i=this._$AH,n=e===p&&i!==p||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,o=e!==p&&(i===p||n);n&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ct=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Q(this,e)}};var zr=le.litHtmlPolyfillSupport;zr?.(ue,me),(le.litHtmlVersions??(le.litHtmlVersions=[])).push("3.3.2");var Ri=(r,e,t)=>{let i=t?.renderBefore??e,n=i._$litPart$;if(n===void 0){let o=t?.renderBefore??null;i._$litPart$=n=new me(e.insertBefore(pe(),o),o,void 0,t??{})}return n._$AI(r),n};var fe=globalThis,P=class extends C{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;let e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ri(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return A}};P._$litElement$=!0,P.finalized=!0,fe.litElementHydrateSupport?.({LitElement:P});var $r=fe.litElementPolyfillSupport;$r?.({LitElement:P});(fe.litElementVersions??(fe.litElementVersions=[])).push("4.2.2");var k=r=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(r,e)}):customElements.define(r,e)};var Mr={attribute:!0,type:String,converter:ae,reflect:!1,hasChanged:Te},Pr=(r=Mr,e,t)=>{let{kind:i,metadata:n}=t,o=globalThis.litPropertyMetadata.get(n);if(o===void 0&&globalThis.litPropertyMetadata.set(n,o=new Map),i==="setter"&&((r=Object.create(r)).wrapped=!0),o.set(t.name,r),i==="accessor"){let{name:s}=t;return{set(a){let c=e.get.call(this);e.set.call(this,a),this.requestUpdate(s,c,r,!0,a)},init(a){return a!==void 0&&this.C(s,void 0,r,a),a}}}if(i==="setter"){let{name:s}=t;return function(a){let c=this[s];e.call(this,a),this.requestUpdate(s,c,r,!0,a)}}throw Error("Unsupported decorator location: "+i)};function v(r){return(e,t)=>typeof t=="object"?Pr(r,e,t):((i,n,o)=>{let s=n.hasOwnProperty(o);return n.constructor.createProperty(o,i),s?Object.getOwnPropertyDescriptor(n,o):void 0})(r,e,t)}function Re(r){return v({...r,state:!0,attribute:!1})}var B=(r,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(r,e,t),t);function Oe(r,e){return(t,i,n)=>{let o=s=>s.renderRoot?.querySelector(r)??null;if(e){let{get:s,set:a}=typeof i=="object"?t:n??(()=>{let c=Symbol();return{get(){return this[c]},set(l){this[c]=l}}})();return B(t,i,{get(){let c=s.call(this);return c===void 0&&(c=o(this),(c!==null||this.hasUpdated)&&a.call(this,c)),c}})}return B(t,i,{get(){return o(this)}})}}var dt=r=>r??p;var Oi={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ji=r=>(...e)=>({_$litDirective$:r,values:e}),je=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var he=class extends je{constructor(e){if(super(e),this.it=p,e.type!==Oi.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===p||e==null)return this._t=void 0,this.it=e;if(e===A)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};he.directiveName="unsafeHTML",he.resultType=1;var J=ji(he);function x(r){return r.split("-").map(e=>e.slice(0,1).toUpperCase()+e.slice(1)).join(" ")}function Li(r){let e=Ut(r),t=Ge(r),i=r.fallbackLang??"zz";return(n,...o)=>Lt(e,t,i,n,...o)}function Tr(r){return{update:()=>{r.requestUpdate()}}}var b=class extends P{_t(e,...t){if(this._translator===void 0){if(this.config===void 0)return e;this._translator=Li(this.config)}return this._translator(e,...t)}createRenderRoot(){return this.getAttribute("mode")==="light"?this:super.createRenderRoot()}_detachWatcher(){this._watcher!==void 0&&this._watcherManager!==void 0&&this._watcherManager.unwatch(this._watcher),this._watcher=void 0,this._watcherManager=void 0}_syncWatcher(){this._watcherManager!==this.manager&&(this._detachWatcher(),this.manager!==void 0&&(this._watcher=Tr(this),this._watcherManager=this.manager,this.manager.watch(this._watcher)))}connectedCallback(){super.connectedCallback(),this._syncWatcher()}disconnectedCallback(){this._detachWatcher(),super.disconnectedCallback()}willUpdate(e){super.willUpdate(e),e.has("config")&&(this._translator=void 0),e.has("manager")&&this._syncWatcher()}_emit(e,t){this.dispatchEvent(new CustomEvent(`simplecmp:${e}`,{detail:t,bubbles:!0,composed:!0}))}};h([v({attribute:!1})],b.prototype,"config",2),h([v({attribute:!1})],b.prototype,"manager",2);var Dr=y`
  :host {
...
`;function Rr(r,e){if(r!==void 0){if(typeof r=="string")return r;if(typeof r=="object")return r[e]??r.default}}var T=class extends b{constructor(){super(...arguments);this.testing=!1;this._previouslyFocused=null;this._handleAccept=()=>{this.manager!==void 0&&(this.manager.changeAll(!0),this.manager.saveAndApplyConsents("accept"),this._emit("accept"))};this._handleDecline=()=>{this.manager!==void 0&&(this.manager.changeAll(!1),this.manager.saveAndApplyConsents("decline"),this._emit("decline"))};this._handleConfigure=t=>{t.preventDefault(),this._emit("configure")}}connectedCallback(){super.connectedCallback(),this.config?.autoFocus===!0&&(this._previouslyFocused=typeof document<"u"?document.activeElement:null,queueMicrotask(()=>{this.renderRoot?.querySelector(".cn-body")?.focus()}))}disconnectedCallback(){super.disconnectedCallback();let t=this._previouslyFocused;this._previouslyFocused=null,t&&typeof t.focus=="function"&&t.isConnected&&t.focus()}render(){let t=this.config,i=this.manager;if(t===void 0||i===void 0)return p;if(!this.testing&&i.confirmed)return p;if(t.noNotice===!0)return p;let n=i.bannerMode==="notice",o=this._activeLang(),s=this._resolvePolicyUrl(t.privacyPolicy,["privacyPolicyUrl"],o),a=this._resolvePolicyUrl(t.imprint,["imprintUrl"],o),c=this._t(["!","consentNotice","title"]),l=t.showNoticeTitle===!0&&c!==void 0,f=t.htmlTexts===!0,m=s?u`<a href=${s}>${this._t(["privacyPolicy","name"])}</a>`:"",d=a?u`<a href=${a}>${this._imprintLinkText()}</a>`:"",g=u`<a
    ...
    >`,_=this._t(n?["consentNotice","optOutDescription"]:["consentNotice","description"],{purposes:u`<strong>${this._purposesText(t)}</strong>`,privacyPolicy:m,imprint:d,learnMoreLink:g});return u`
      ...
      >
        ...
        <p id="cn-description">${f?Or(_):_}</p>
    ...
    `}_renderPurposes(t){let i=t.purposes??[];if(i.length===0)return p;let n=i.map(s=>this._tString(["!","purposes",s,"title?"])||x(s)).join(", "),o=this._t(["service",i.length>1?"purposes":"purpose"]);return u`<p class="purposes">${o}: ${n}</p>`}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};H.styles=[ge,y`
      :host {
        display: block;
    ...
    `}_activeLang(){return this.config?.lang??document.documentElement.lang??"en"}_collectFocusable(){let t=this._dialog;if(t===void 0)return[];let i=[],n='button:not([disabled]), a[href], input:not([disabled]):not([type="hidden"]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',o=s=>{if(s.matches(n)&&this._isVisible(s)&&i.push(s),s.shadowRoot!==null)for(let a of s.shadowRoot.children)o(a);for(let a of s.children)o(a)};for(let s of t.children)o(s);return i}_deepActiveElement(){let t=document.activeElement;for(;t?.shadowRoot?.activeElement;)t=t.shadowRoot.activeElement;return t}_isVisible(t){let i=t;return typeof i.checkVisibility=="function"?i.checkVisibility():t.offsetParent!==null}_collectPurposes(){let t=new Map;for(let i of this.config?.services??[])for(let n of i.purposes??[]){let o=t.get(n)??[];o.push(i),t.set(n,o)}return t}_resolvePolicyUrl(t,i,n){let o=jr(t,n);if(o!==void 0)return o;let s=this._tString(["!",...i]);return s===""?void 0:s}_imprintLinkText(){return this._tString(["!","consentNotice","imprint","name"])||this._tString(["!","imprint","name"])||"Imprint"}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};S.styles=[w,y`
      :host {
        display: contents;
      }
    ...
    `],h([v({type:String})],E.prototype,"position",2),h([v({type:String})],E.prototype,"label",2),E=h([k("simplecmp-trigger")],E);function Ii(r){let e=re(r),t=r.domMode==="light",i;r.noNotice!==!0&&e.bannerMode!=="none"&&(!e.confirmed||r.testing===!0)&&(i=new T,i.config=r,i.manager=e,r.testing===!0&&(i.testing=!0),t&&i.setAttribute("mode","light"),document.body.appendChild(i));let o=new S;o.config=r,o.manager=e,r.testing===!0&&(o.testing=!0),t&&o.setAttribute("mode","light"),document.body.appendChild(o),r.mustConsent===!0&&!e.confirmed&&(o.open=!0);let s=()=>{o.open=!0};document.addEventListener("simplecmp:configure",s);let a={update(f,m){m==="saveConsents"&&i!==void 0&&(i.remove(),i=void 0)}};e.watch(a);let c,l;return r.floatingTrigger&&(c=new E,c.config=r,typeof r.floatingTrigger=="object"&&(r.floatingTrigger.position!==void 0&&(c.position=r.floatingTrigger.position),r.floatingTrigger.label!==void 0&&(c.label=r.floatingTrigger.label)),t&&c.setAttribute("mode","light"),document.body.appendChild(c),l=()=>{o.open=!0},c.addEventListener("simplecmp:trigger-click",l)),e.applyConsents(),{show(){o.open=!0},hide(){o.open=!1},destroy(){e.unwatch(a),document.removeEventListener("simplecmp:configure",s),i?.remove(),o.remove(),c!==void 0&&l!==void 0&&(c.removeEventListener("simplecmp:trigger-click",l),c.remove())},manager:e}}var Ni=`:where(
    simplecmp-banner,
    simplecmp-modal,
    simplecmp-purpose-group,
    simplecmp-service-toggle,
...
`;var ut="data-simplecmp-theme",qi={bootstrap5:Ni,tailwind4:Hi,bulma:Ui,pico:Bi};function Fi(r){if(typeof document>"u")return;let e=document.querySelector(`style[${ut}]`);if(r===void 0||r==="default"){e?.remove();return}let t=qi[r];if(t===void 0){console.warn(`SimpleCMP: theme "${r}" has no adapter; ignoring. Known themes: ${Object.keys(qi).join(", ")}, 'default'.`);return}if(e?.getAttribute(ut)===r)return;let i=e instanceof HTMLStyleElement?e:document.createElement("style");i.setAttribute(ut,r),i.textContent=t,i.isConnected||document.head.appendChild(i)}function Ir(r){return wt(r)}function Nr(r){return St(r)}function Ur(r){return Le(r)}z(Ze,V(mi));var Br="0.0.1",X=null,q=null,F=null;function Hr(r){to(r),io(r);let e=Yr(),t=e?{...r,testing:!0}:r;e&&eo(),X!==null&&(X.destroy(),X=null),q!==null&&(q(),q=null),F!==null&&(F(),F=null),Fi(r.theme);let i=re(t);t.record&&Kr(t),t.interceptRuntime&&(q=qr(t,i)),t.consentMode&&(F=Qe(t.consentMode,i,t.services));let n=null,o=[],s=()=>{n=Ii(t);for(let c of o)c==="show"?n.show():n.hide();o.length=0},a=null;return typeof document<"u"&&document.body!==null?s():typeof document<"u"&&(a=s,document.addEventListener("DOMContentLoaded",a,{once:!0})),X={show:()=>{n!==null?n.show():o.push("show")},hide:()=>{n!==null?n.hide():o.push("hide")},manager:i,destroy:()=>{q!==null&&(q(),q=null),F!==null&&(F(),F=null),a!==null&&typeof document<"u"&&(document.removeEventListener("DOMContentLoaded",a),a=null),n?.destroy(),n=null,o.length=0}},X}function qr(r,e){let t=typeof r.interceptRuntime=="object"&&r.interceptRuntime!==null?r.interceptRuntime:{},i=gi(r.services,{blockAllUnknown:t.universalBlock===!0}),n=t.onBlock;return hi({matcher:i,consentChecker:o=>e.getConsent(o),sameOriginHosts:t.sameOriginHosts,onBlock:o=>{j!==null&&j.recordSyntheticDetection({kind:Fr(o.mechanism),identifier:o.url,origin:Vr(o.url)}),n?.(o)}})}function Fr(r){switch(r){case"script-src":return"script";case"iframe-src":return"iframe";case"img-src":return"image";case"fetch":case"xhr":case"sendBeacon":return"request"}}function Vr(r){try{return new URL(r,window.location.href).hostname||void 0}catch{return}}function Wr(){X?.show()}var j=null;function Kr(r){j&&(j.stop(),j=null);let e=typeof r.record=="object"&&r.record!==null?{...r.record}:{};if(!e.storageName&&typeof r.storageName=="string"&&(e.storageName=r.storageName),e.storageName){let s=e.ignoreCookies??[];e.ignoreCookies=s.includes(e.storageName)?s:[e.storageName,...s]}let t=r.services??[],i=r.serviceDbUrl?new G(new K({url:r.serviceDbUrl,auth:r.serviceDbAuth}),t):null,n=i??new W(t),o=new Ae({options:e,classifier:n,services:t,watcherFactories:[s=>new xe(s,{intervalMs:e.cookieIntervalMs}),s=>new Ee(s),s=>new ze(s)],onDetectionForLibEvent:s=>{Je("recorderDetection",s)}});if(i&&i.onEnrichment((s,a)=>{o.enrichDetection(s,a)}),r.cmsBridgeUrl){let s=Xr(),a=new L({url:r.cmsBridgeUrl,auth:r.cmsBridgeAuth,source:r.cmsBridge?.source??e.storageName??"default",dedupTtlMs:r.cmsBridge?.dedupTtlMs,crossSessionDedupMs:s?0:r.cmsBridge?.crossSessionDedupMs,flushDebounceMs:r.cmsBridge?.flushDebounceMs,maxBatchSize:r.cmsBridge?.maxBatchSize,sampleRate:s?1:r.cmsBridge?.sampleRate,respectDoNotTrack:s?!1:r.cmsBridge?.respectDoNotTrack,timeoutMs:r.cmsBridge?.timeoutMs,reportGeneration:r.cmsBridge?.reportGeneration});o.on("detectionSettled",c=>a.onDetection(c))}j=o,j.start()}function Gr(){return j??void 0}var Qr=Nt,Zr=re,Jr=ie;function Xr(){if(typeof window>"u"||typeof URLSearchParams>"u")return!1;try{return new URLSearchParams(window.location.search).get("simplecmp_discover")==="1"}catch{return!1}}function Yr(){if(typeof window>"u"||typeof URLSearchParams>"u")return!1;try{if(new URLSearchParams(window.location.search).get("simplecmp_audit")==="1")return!0;let e=window.location.hash;return e.length>1&&new URLSearchParams(e.slice(1)).get("simplecmp_audit")==="1"}catch{return!1}}function eo(){typeof window>"u"||requestAnimationFrame(()=>{requestAnimationFrame(()=>{requestAnimationFrame(()=>{let r=Le();try{window.parent.postMessage({type:"simplecmp-audit-from-fe",results:r,location:{href:window.location.href,host:window.location.host}},"*")}catch{}})})})}function to(r){r.cmsBridgeUrl&&!r.record&&console.warn("SimpleCMP: `cmsBridgeUrl` is set but `record` is not enabled. The CMS bridge listens to recorder detections \u2014 without the recorder running, no webhooks will ever fire. Set `record: true` or remove `cmsBridgeUrl`.")}function io(r){r.hideDeclineAll&&console.warn('SimpleCMP: `hideDeclineAll: true` hides the "Decline all" button on the first banner level. This is incompatible with German consent requirements (BGH "Cookie II", BGH I ZR 7/16; DSK 2022). Keep the decline option equally prominent or expect compliance issues.')}return Zi(no);})();
