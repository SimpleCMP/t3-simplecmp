...
`;function mr(r,e){if(r!==void 0){if(typeof r=="string")return r;if(typeof r=="object")return r[e]??r.default}}var M=class extends y{constructor(){super(...arguments);this.testing=!1;this._handleAccept=()=>{this.manager!==void 0&&(this.manager.changeAll(!0),this.manager.saveAndApplyConsents("accept"),this._emit("accept"))};this._handleDecline=()=>{this.manager!==void 0&&(this.manager.changeAll(!1),this.manager.saveAndApplyConsents("decline"),this._emit("decline"))};this._handleConfigure=t=>{t.preventDefault(),this._emit("configure")}}connectedCallback(){super.connectedCallback(),this.config?.autoFocus===!0&&queueMicrotask(()=>this.focus())}render(){let t=this.config,i=this.manager;if(t===void 0||i===void 0)return l;if(!this.testing&&i.confirmed)return l;if(t.noNotice===!0)return l;let n=this._activeLang(),o=this._resolvePolicyUrl(t.privacyPolicy,["privacyPolicyUrl"],n),s=this._resolvePolicyUrl(t.imprint,["imprintUrl"],n),a=this._t(["!","consentNotice","title"]),c=t.showNoticeTitle===!0&&a!==void 0,p=t.htmlTexts===!0,f=o?d`<a href=${o}>${this._t(["privacyPolicy","name"])}</a>`:"",u=s?d`<a href=${s}>${this._imprintLinkText()}</a>`:"",m=d`<a
    ...
    >`,v=this._t(["consentNotice","description"],{purposes:d`<strong>${this._purposesText(t)}</strong>`,privacyPolicy:f,imprint:u,learnMoreLink:m});return d`
      <div
        class="cn-body"
        role="dialog"
        aria-labelledby=${st(c?"cn-title":void 0)}
        aria-label=${st(c?void 0:a)}
        aria-describedby="cn-description"
        tabindex="0"
      >
        ${c?d`<h2 id="cn-title">${a}</h2>`:l}
        <p id="cn-description">${p?fr(v):v}</p>
    ...
    </div>`}_resolveLayout(t){let i=(t.layout??"standard").toString().toLowerCase();return i==="compact"||i==="stacked"?i:"standard"}_activeLang(){return this.config?.lang??document.documentElement.lang??"en"}_purposesText(t){let i=t.purposeOrder??[],o=Pt(t).filter(c=>c!=="functional").sort((c,p)=>i.indexOf(c)-i.indexOf(p)).map(c=>this._tString(["!","purposes",c,"title?"])||x(c));if(o.length<=1)return o[0]??"";let s=o.slice(0,-2),a=o.slice(-2).join(" & ");return[...s,a].join(", ")}_resolvePolicyUrl(t,i,n){let o=mr(t,n);if(o!==void 0)return o;let s=this._tString(["!",...i]);return s===""?void 0:s}_imprintLinkText(){return this._tString(["!","consentNotice","imprint","name"])||this._tString(["!","imprint","name"])||"Imprint"}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}_renderPolicyLinks(t,i){return t===void 0&&i===void 0?l:d`
    ...
    `}_renderBody(t){let i=[],n=(o,s,a=!1)=>{if(s===void 0||s==="")return;let c=this._tString(["providerInfo","field",o])||o,p=a?d`<a href=${s} target="_blank" rel="noopener noreferrer">${s}</a>`:d`${s}`;i.push(d`<dt>${c}</dt><dd>${p}</dd>`)};return n("vendor",t.vendor),n("description",t.vendorDescription),n("address",t.vendorAddress),n("country",t.vendorCountry),n("privacyPolicy",t.privacyPolicyUrl,!0),n("optOut",t.vendorOptOutUrl,!0),n("partner",t.vendorPartner),i.length===0?d`<p class="empty">
      ...
      </p>`:d`<dl>${i}</dl>`}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};T.styles=[w,b`
      :host {
        display: contents;
      }
    ...
    `],h([g({attribute:!1})],D.prototype,"service",2),h([g({type:String,attribute:"service-name"})],D.prototype,"serviceName",2),h([Pe()],D.prototype,"_providerInfoOpen",2),D=h([k("simplecmp-contextual-notice")],D);var H=class extends y{constructor(){super(...arguments);this.visible=!0;this._onChange=t=>{let i=t.target.checked,n=this.service;n===void 0||n.required||(this.manager?.updateConsent(n.name,i),this._emit("service-toggle",{name:n.name,value:i}))}}render(){let t=this.service;if(t===void 0)return l;let i=`simplecmp-service-${t.name}`,n=t.required===!0||this.manager?.consents[t.name]===!0,o=this._tString(["!",t.name,"title?"])||x(t.name),s=this._tString(["!",t.name,"description?"])||void 0;return d`
      <div class="row">
        <input
          type="checkbox"
          id=${i}
    ...
    `}_renderPurposes(t){let i=t.purposes??[];if(i.length===0)return l;let n=i.map(s=>this._tString(["!","purposes",s,"title?"])||x(s)).join(", "),o=this._t(["service",i.length>1?"purposes":"purpose"]);return d`<p class="purposes">${o}: ${n}</p>`}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};H.styles=[w,b`
      :host {
        display: block;
    ...
    `}_activeLang(){return this.config?.lang??document.documentElement.lang??"en"}_collectFocusable(){let t=this._dialog;if(t===void 0)return[];let i=[],n='button:not([disabled]), a[href], input:not([disabled]):not([type="hidden"]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',o=s=>{if(s.matches(n)&&this._isVisible(s)&&i.push(s),s.shadowRoot!==null)for(let a of s.shadowRoot.children)o(a);for(let a of s.children)o(a)};for(let s of t.children)o(s);return i}_deepActiveElement(){let t=document.activeElement;for(;t?.shadowRoot?.activeElement;)t=t.shadowRoot.activeElement;return t}_isVisible(t){let i=t;return typeof i.checkVisibility=="function"?i.checkVisibility():t.offsetParent!==null}_collectPurposes(){let t=new Map;for(let i of this.config?.services??[])for(let n of i.purposes??[]){let o=t.get(n)??[];o.push(i),t.set(n,o)}return t}_resolvePolicyUrl(t,i,n){let o=hr(t,n);if(o!==void 0)return o;let s=this._tString(["!",...i]);return s===""?void 0:s}_imprintLinkText(){return this._tString(["!","consentNotice","imprint","name"])||this._tString(["!","imprint","name"])||"Imprint"}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};S.styles=[w,b`
      :host {
        display: contents;
      }
    ...
    `],h([g({type:String})],C.prototype,"position",2),h([g({type:String})],C.prototype,"label",2),C=h([k("simplecmp-trigger")],C);function Ti(r){let e=ne(r),t=r.domMode==="light",i;r.noNotice!==!0&&(!e.confirmed||r.testing===!0)&&(i=new M,i.config=r,i.manager=e,r.testing===!0&&(i.testing=!0),t&&i.setAttribute("mode","light"),document.body.appendChild(i));let o=new S;o.config=r,o.manager=e,r.testing===!0&&(o.testing=!0),t&&o.setAttribute("mode","light"),document.body.appendChild(o),r.mustConsent===!0&&!e.confirmed&&(o.open=!0);let s=()=>{o.open=!0};document.addEventListener("simplecmp:configure",s);let a={update(f,u){u==="saveConsents"&&i!==void 0&&(i.remove(),i=void 0)}};e.watch(a);let c,p;return r.floatingTrigger&&(c=new C,c.config=r,typeof r.floatingTrigger=="object"&&(r.floatingTrigger.position!==void 0&&(c.position=r.floatingTrigger.position),r.floatingTrigger.label!==void 0&&(c.label=r.floatingTrigger.label)),t&&c.setAttribute("mode","light"),document.body.appendChild(c),p=()=>{o.open=!0},c.addEventListener("simplecmp:trigger-click",p)),e.applyConsents(),{show(){o.open=!0},hide(){o.open=!1},destroy(){e.unwatch(a),document.removeEventListener("simplecmp:configure",s),i?.remove(),o.remove(),c!==void 0&&p!==void 0&&(c.removeEventListener("simplecmp:trigger-click",p),c.remove())},manager:e}}var Di=`:where(
    simplecmp-banner,
    simplecmp-modal,
    simplecmp-purpose-group,
    simplecmp-service-toggle,
...
`;var at="data-simplecmp-theme",Li={bootstrap5:Di,tailwind4:ji,bulma:Oi,pico:Ri};function Ii(r){if(typeof document>"u")return;let e=document.querySelector(`style[${at}]`);if(r===void 0||r==="default"){e?.remove();return}let t=Li[r];if(t===void 0){console.warn(`SimpleCMP: theme "${r}" has no adapter; ignoring. Known themes: ${Object.keys(Li).join(", ")}, 'default'.`);return}if(e?.getAttribute(at)===r)return;let i=e instanceof HTMLStyleElement?e:document.createElement("style");i.setAttribute(at,r),i.textContent=t,i.isConnected||document.head.appendChild(i)}function vr(r){return gt(r)}function yr(r){return vt(r)}function br(r){return De(r)}z(Ve,F(ai));var kr="0.0.1",J=null,q=null;function wr(r){Or(r),Rr(r);let e=Tr(),t=e?{...r,testing:!0}:r;e&&Dr(),J!==null&&(J.destroy(),J=null),q!==null&&(q(),q=null),Ii(r.theme);let i=ne(t);t.record&&Cr(t),t.interceptRuntime&&(q=Sr(t,i));let n=null,o=[],s=()=>{n=Ti(t);for(let c of o)c==="show"?n.show():n.hide();o.length=0},a=null;return typeof document<"u"&&document.body!==null?s():typeof document<"u"&&(a=s,document.addEventListener("DOMContentLoaded",a,{once:!0})),J={show:()=>{n!==null?n.show():o.push("show")},hide:()=>{n!==null?n.hide():o.push("hide")},manager:i,destroy:()=>{q!==null&&(q(),q=null),a!==null&&typeof document<"u"&&(document.removeEventListener("DOMContentLoaded",a),a=null),n?.destroy(),n=null,o.length=0}},J}function Sr(r,e){let t=typeof r.interceptRuntime=="object"&&r.interceptRuntime!==null?r.interceptRuntime:{},i=pi(r.services,{blockAllUnknown:t.universalBlock===!0}),n=t.onBlock;return li({matcher:i,consentChecker:o=>e.getConsent(o),sameOriginHosts:t.sameOriginHosts,onBlock:o=>{R!==null&&R.recordSyntheticDetection({kind:_r(o.mechanism),identifier:o.url,origin:Ar(o.url)}),n?.(o)}})}function _r(r){switch(r){case"script-src":return"script";case"iframe-src":return"iframe";case"img-src":return"image";case"fetch":case"xhr":case"sendBeacon":return"request"}}function Ar(r){try{return new URL(r,window.location.href).hostname||void 0}catch{return}}function xr(){J?.show()}var R=null;function Cr(r){R&&(R.stop(),R=null);let e=typeof r.record=="object"&&r.record!==null?{...r.record}:{};if(!e.storageName&&typeof r.storageName=="string"&&(e.storageName=r.storageName),e.storageName){let s=e.ignoreCookies??[];e.ignoreCookies=s.includes(e.storageName)?s:[e.storageName,...s]}let t=r.services??[],i=r.serviceDbUrl?new K(new W({url:r.serviceDbUrl,auth:r.serviceDbAuth}),t):null,n=i??new V(t),o=new we({options:e,classifier:n,services:t,watcherFactories:[s=>new Se(s,{intervalMs:e.cookieIntervalMs}),s=>new _e(s),s=>new Ae(s)],onDetectionForLibEvent:s=>{We("recorderDetection",s)}});if(i&&i.onEnrichment((s,a)=>{o.enrichDetection(s,a)}),r.cmsBridgeUrl){let s=Mr(),a=new j({url:r.cmsBridgeUrl,auth:r.cmsBridgeAuth,source:r.cmsBridge?.source??e.storageName??"default",dedupTtlMs:r.cmsBridge?.dedupTtlMs,crossSessionDedupMs:s?0:r.cmsBridge?.crossSessionDedupMs,flushDebounceMs:r.cmsBridge?.flushDebounceMs,maxBatchSize:r.cmsBridge?.maxBatchSize,sampleRate:s?1:r.cmsBridge?.sampleRate,respectDoNotTrack:s?!1:r.cmsBridge?.respectDoNotTrack,timeoutMs:r.cmsBridge?.timeoutMs});o.on("detectionSettled",c=>a.onDetection(c))}R=o,R.start()}function zr(){return R??void 0}var $r=Dt,Er=ne,Pr=te;function Mr(){if(typeof window>"u"||typeof URLSearchParams>"u")return!1;try{return new URLSearchParams(window.location.search).get("simplecmp_discover")==="1"}catch{return!1}}function Tr(){if(typeof window>"u"||typeof URLSearchParams>"u")return!1;try{if(new URLSearchParams(window.location.search).get("simplecmp_audit")==="1")return!0;let e=window.location.hash;return e.length>1&&new URLSearchParams(e.slice(1)).get("simplecmp_audit")==="1"}catch{return!1}}function Dr(){typeof window>"u"||requestAnimationFrame(()=>{requestAnimationFrame(()=>{requestAnimationFrame(()=>{let r=De();try{window.parent.postMessage({type:"simplecmp-audit-from-fe",results:r,location:{href:window.location.href,host:window.location.host}},"*")}catch{}})})})}function Or(r){r.cmsBridgeUrl&&!r.record&&console.warn("SimpleCMP: `cmsBridgeUrl` is set but `record` is not enabled. The CMS bridge listens to recorder detections \u2014 without the recorder running, no webhooks will ever fire. Set `record: true` or remove `cmsBridgeUrl`.")}function Rr(r){r.hideDeclineAll&&console.warn('SimpleCMP: `hideDeclineAll: true` hides the "Decline all" button on the first banner level. This is incompatible with German consent requirements (BGH "Cookie II", BGH I ZR 7/16; DSK 2022). Keep the decline option equally prominent or expect compliance issues.')}return Fi(jr);})();
