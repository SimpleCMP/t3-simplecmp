...
`;function Lr(r,e){if(r!==void 0){if(typeof r=="string")return r;if(typeof r=="object")return r[e]??r.default}}var T=class extends b{constructor(){super(...arguments);this.testing=!1;this._previouslyFocused=null;this._handleAccept=()=>{this.manager!==void 0&&(this.manager.changeAll(!0),this.manager.saveAndApplyConsents("accept"),this._emit("accept"))};this._handleDecline=()=>{this.manager!==void 0&&(this.manager.changeAll(!1),this.manager.saveAndApplyConsents("decline"),this._emit("decline"))};this._handleConfigure=t=>{t.preventDefault(),this._emit("configure")}}connectedCallback(){super.connectedCallback(),this.config?.autoFocus===!0&&(this._previouslyFocused=typeof document<"u"?document.activeElement:null,queueMicrotask(()=>{this.renderRoot?.querySelector(".cn-body")?.focus()}))}disconnectedCallback(){super.disconnectedCallback();let t=this._previouslyFocused;this._previouslyFocused=null,t&&typeof t.focus=="function"&&t.isConnected&&t.focus()}render(){let t=this.config,i=this.manager;if(t===void 0||i===void 0)return p;if(!this.testing&&i.confirmed)return p;if(t.noNotice===!0)return p;let n=i.bannerMode==="notice",o=this._activeLang(),s=this._resolvePolicyUrl(t.privacyPolicy,["privacyPolicyUrl"],o),a=this._resolvePolicyUrl(t.imprint,["imprintUrl"],o),c=this._t(["!","consentNotice","title"]),l=t.showNoticeTitle===!0&&c!==void 0,f=t.htmlTexts===!0,d=s?m`<a href=${s}>${this._t(["privacyPolicy","name"])}</a>`:"",u=a?m`<a href=${a}>${this._imprintLinkText()}</a>`:"",g=m`<a
    ...
    >`,_=this._t(n?["consentNotice","optOutDescription"]:["consentNotice","description"],{purposes:m`<strong>${this._purposesText(t)}</strong>`,privacyPolicy:d,imprint:u,learnMoreLink:g});return m`
      <div
        ...
        tabindex="-1"
      >
        ${l?m`<h2 id="cn-title">${c}</h2>`:p}
        <p id="cn-description">${f?Nr(_):_}</p>
        ${this._renderPolicyLinks(s,a)}
        ${i.changed?m`<p class="cn-changes">${this._t(["consentNotice","changeDescription"])}</p>`:p}
        ${this.testing?m`<p>${this._t(["consentNotice","testing"])}</p>`:p}
        ${n?this._renderNoticeButtons(t):this._renderButtonRow(t)}
      </div>
    `}_renderNoticeButtons(t){let i=this._resolveLayout(t),n=t.hideLearnMore!==!0;return m`<div class="cn-buttons cn-layout-${i}">
      ${n?m`<button
            type="button"
            class="cn-configure"
            @click=${this._handleConfigure}
    ...
    </div>`}_renderButtonRow(t){let i=this._resolveLayout(t),n=i!=="compact"&&t.hideLearnMore!==!0,o=t.hideDeclineAll!==!0;return m`<div class="cn-buttons cn-layout-${i}">
      ${n?m`<button
            type="button"
            class="cn-configure"
            @click=${this._handleConfigure}
    ...
    </div>`}_resolveLayout(t){let i=(t.layout??"standard").toString().toLowerCase();return i==="compact"||i==="stacked"?i:"standard"}_activeLang(){return this.config?.lang??document.documentElement.lang??"en"}_purposesText(t){let i=t.purposeOrder??[],o=jt(t).filter(c=>c!=="functional").sort((c,l)=>i.indexOf(c)-i.indexOf(l)).map(c=>this._tString(["!","purposes",c,"title?"])||x(c));if(o.length<=1)return o[0]??"";let s=o.slice(0,-2),a=o.slice(-2).join(" & ");return[...s,a].join(", ")}_resolvePolicyUrl(t,i,n){let o=Lr(t,n);if(o!==void 0)return o;let s=this._tString(["!",...i]);return s===""?void 0:s}_imprintLinkText(){return this._tString(["!","consentNotice","imprint","name"])||this._tString(["!","imprint","name"])||"Imprint"}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}_renderPolicyLinks(t,i){return t===void 0&&i===void 0?p:m`
      <p class="cn-policy-links">
        ${t?m`<a href=${t}>${this._t(["privacyPolicy","name"])}</a>`:p}
        ${t&&i?" \xB7 ":p}
        ${i?m`<a href=${i}>${this._imprintLinkText()}</a>`:p}
      </p>
    `}};T.styles=[w,y`
      :host {
        display: block;
    ...
    `}_renderBody(t){let i=[],n=(o,s,a=!1)=>{if(s===void 0||s==="")return;let c=this._tString(["providerInfo","field",o])||o,l=a&&ve(s)?m`<a href=${s} target="_blank" rel="noopener noreferrer">${s}</a>`:m`${s}`;i.push(m`<dt>${c}</dt><dd>${l}</dd>`)};return n("vendor",t.vendor),n("description",t.vendorDescription),n("address",t.vendorAddress),n("country",t.vendorCountry),n("privacyPolicy",t.privacyPolicyUrl,!0),n("optOut",t.vendorOptOutUrl,!0),n("partner",t.vendorPartner),i.length===0?m`<p class="empty">
        ${this._tString(["providerInfo","noData"])||"No provider information available."}
      </p>`:m`<dl>${i}</dl>`}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};D.styles=[w,y`
      :host {
        display: contents;
      }
    ...
    `],h([v({attribute:!1})],D.prototype,"service",2),h([v({type:Boolean,reflect:!0})],D.prototype,"open",2),h([Oe("dialog")],D.prototype,"_dialog",2),D=h([k("simplecmp-provider-info-modal")],D);var R=class extends b{constructor(){super(...arguments);this._autoPlaceholder=!1;this._providerInfoOpen=!1;this._onAcceptOnce=()=>{let t=this._resolveService();t===void 0||this.manager===void 0||(this.manager.updateConsent(t.name,!0),this.manager.applyConsents(!1,!0,t.name),this.manager.updateConsent(t.name,!1),this._emit("contextual-accept-once",{name:t.name}))};this._onAccept=()=>{let t=this._resolveService();t===void 0||this.manager===void 0||(this.manager.updateConsent(t.name,!0),this.manager.confirmed?(this.manager.saveConsents("contextual-accept"),this.manager.applyConsents(!1,!0,t.name)):this.manager.applyConsents(!1,!0,t.name),this._emit("contextual-accept",{name:t.name}))};this._onConfigure=t=>{t.preventDefault(),this._emit("configure")};this._onProviderInfoOpen=t=>{t.preventDefault(),this._providerInfoOpen=!0};this._onProviderInfoClose=()=>{this._providerInfoOpen=!1}}connectedCallback(){super.connectedCallback(),this._autoPlaceholder=this.hasAttribute("data-simplecmp-auto-placeholder"),this.hasAttribute("role")||this.setAttribute("role","region")}_resolveService(){if(this.service!==void 0)return this.service;if(this.serviceName!==void 0){if(this.config!==void 0){let t=this.config.services.find(i=>i.name===this.serviceName);if(t!==void 0)return t}return{name:this.serviceName,purposes:[]}}}_renderMode(){let t=this.service?.name??this.serviceName;return t===void 0||this.config?.services.some(n=>n.name===t)===!0?"configured":this.getAttribute("data-blocked-source")==="host"?"host":"library"}render(){let t=this._resolveService();if(t===void 0||this.manager===void 0)return p;let i=this._renderMode(),n=i==="host"?t.name:this._resolveTitle(t),o=i==="host"?this._t(["contextualConsent","descriptionUnknownHost"],{title:n}):this._resolveDescription(t,n);if(i==="host")return m`<p>${o}</p>`;let s=this.manager.store.get()!==null,a=i==="configured"&&s,c=i==="configured";return m`
      ...
      <div class="buttons">
        ...
        ${a?m`<button type="button" class="accept" @click=${this._onAccept}>
              ${this._t(["contextualConsent","acceptAlways"])}
            </button>`:p}
        ${c?m`<button type="button" class="configure" @click=${this._onConfigure}>
              ${this._t(["contextualConsent","modalLinkText"])}
            </button>`:p}
      </div>
      ${this._renderProviderInfoModal(t)}
    `}_renderProviderInfoLink(t){return this._hasProviderData(t)?m`
    ...
    `:p}_renderProviderInfoModal(t){return this._providerInfoOpen?m`
      ...
      <div class="row">
        ...
        <div class="meta">
          <label for=${i}>
            ...
            ${t.required?m`<span class="badge">${this._t(["service","required","title"])}</span>`:p}
            ${t.optOut?m`<span class="badge">${this._t(["service","optOut","title"])}</span>`:p}
          </label>
          ${s?m`<p class="description">${s}</p>`:p}
          ${this._renderPurposes(t)}
        </div>
      </div>
    `}_renderPurposes(t){let i=t.purposes??[];if(i.length===0)return p;let n=i.map(s=>this._tString(["!","purposes",s,"title?"])||x(s)).join(", "),o=this._t(["service",i.length>1?"purposes":"purpose"]);return m`<p class="purposes">${o}: ${n}</p>`}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};H.styles=[ge,y`
      :host {
        display: block;
    ...
    `],h([v({attribute:!1})],H.prototype,"service",2),h([v({type:Boolean})],H.prototype,"visible",2),H=h([k("simplecmp-service-toggle")],H);var O=class extends b{constructor(){super(...arguments);this.purpose="";this.services=[];this._expanded=!1;this._onMasterChange=t=>{let i=t.target.checked;if(this.manager!==void 0){for(let n of this.services)n.required!==!0&&this.manager.updateConsent(n.name,i);this._emit("purpose-toggle",{purpose:this.purpose,value:i})}};this._toggleExpanded=t=>{t.preventDefault(),this._expanded=!this._expanded}}render(){if(this.manager===void 0)return p;let t=this._computeStatus(),i=this._tString(["!","purposes",this.purpose,"title?"])||x(this.purpose),n=this._tString(["!","purposes",this.purpose,"description"]),o=`simplecmp-purpose-${this.purpose}`;return m`
      <div class="header">
        ...
        <div class="meta">
          ...
          ${n?m`<p class="description">${n}</p>`:p}
        </div>
      </div>

      ${this.services.length>0?m`
            <button
              type="button"
    ...
    `}_renderHeader(t){let i=this._activeLang(),n=this._resolvePolicyUrl(t.privacyPolicy,["privacyPolicyUrl"],i),o=this._resolvePolicyUrl(t.imprint,["imprintUrl"],i),s=t.htmlTexts===!0,a=this._t(["consentModal","description"]),c=t.mustConsent!==!0;return m`
      <div class="header">
        ${c?m`<button
              type="button"
              class="close"
    ...
    `}_renderBody(t){if(t.groupByPurpose!==!1){let n=this._collectPurposes(),o=t.purposeOrder??[],s=Array.from(n.keys()).sort((a,c)=>o.indexOf(a)-o.indexOf(c));return m`
        <div class="purposes">
          ${s.map(a=>m`
    ...
    `}_renderFooter(t,i){let n=t.hideDeclineAll!==!0,o=t.acceptAll===!0,s=i.confirmed?this._t(["save"]):this._t(["acceptSelected"]);return m`
      <div class="footer">
        ${n?m`<button type="button" class="action decline" @click=${this._onDecline}>
              ${this._t(["decline"])}
            </button>`:p}
        <button type="button" class="action save" @click=${this._onSave}>
          ${s}
        </button>
        ${o?m`<button type="button" class="action accept-all" @click=${this._onAcceptAll}>
              ${this._t(["acceptAll"])}
            </button>`:p}
      </div>
    `}_renderPolicyLinks(t,i){let n=t!==void 0&&ve(t)?t:void 0,o=i!==void 0&&ve(i)?i:void 0;return n===void 0&&o===void 0?p:m`
      <p class="policy-links">
        ${n?m`<a href=${n} target="_blank" rel="noopener"
              >${this._t(["privacyPolicy","name"])}</a
            >`:p}
        ${n&&o?" \xB7 ":p}
        ${o?m`<a href=${o} target="_blank" rel="noopener"
              >${this._imprintLinkText()}</a
            >`:p}
      </p>
    `}_activeLang(){return this.config?.lang??document.documentElement.lang??"en"}_collectFocusable(){let t=this._dialog;if(t===void 0)return[];let i=[],n='button:not([disabled]), a[href], input:not([disabled]):not([type="hidden"]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',o=s=>{if(s.matches(n)&&this._isVisible(s)&&i.push(s),s.shadowRoot!==null)for(let a of s.shadowRoot.children)o(a);for(let a of s.children)o(a)};for(let s of t.children)o(s);return i}_deepActiveElement(){let t=document.activeElement;for(;t?.shadowRoot?.activeElement;)t=t.shadowRoot.activeElement;return t}_isVisible(t){let i=t;return typeof i.checkVisibility=="function"?i.checkVisibility():t.offsetParent!==null}_collectPurposes(){let t=new Map;for(let i of this.config?.services??[])for(let n of i.purposes??[]){let o=t.get(n)??[];o.push(i),t.set(n,o)}return t}_resolvePolicyUrl(t,i,n){let o=Ir(t,n);if(o!==void 0)return o;let s=this._tString(["!",...i]);return s===""?void 0:s}_imprintLinkText(){return this._tString(["!","consentNotice","imprint","name"])||this._tString(["!","imprint","name"])||"Imprint"}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};S.styles=[w,y`
      :host {
        display: contents;
      }
    ...
    `],h([v({type:Boolean,reflect:!0})],S.prototype,"open",2),h([v({type:Boolean})],S.prototype,"testing",2),h([Oe("dialog")],S.prototype,"_dialog",2),S=h([k("simplecmp-modal")],S);function Ur(r){return typeof r=="string"?J(r):Array.isArray(r)?r.map(e=>typeof e=="string"?J(e):e):r}var E=class extends b{constructor(){super(...arguments);this.position="bottom-right";this._onClick=t=>{t.preventDefault(),this._emit("trigger-click")}}connectedCallback(){super.connectedCallback(),this.setAttribute("position",this.position)}render(){let t=this._resolveLabel();return m`
    ...
    `],h([v({type:String})],E.prototype,"position",2),h([v({type:String})],E.prototype,"label",2),E=h([k("simplecmp-trigger")],E);function Ii(r){let e=re(r),t=r.domMode==="light",i;r.noNotice!==!0&&e.bannerMode!=="none"&&(!e.confirmed||r.testing===!0)&&(i=new T,i.config=r,i.manager=e,r.testing===!0&&(i.testing=!0),t&&i.setAttribute("mode","light"),document.body.appendChild(i));let o=new S;o.config=r,o.manager=e,r.testing===!0&&(o.testing=!0),t&&o.setAttribute("mode","light"),document.body.appendChild(o),r.mustConsent===!0&&!e.confirmed&&(o.open=!0);let s=()=>{o.open=!0};document.addEventListener("simplecmp:configure",s);let a={update(f,d){d==="saveConsents"&&i!==void 0&&(i.remove(),i=void 0)}};e.watch(a);let c,l;return r.floatingTrigger&&(c=new E,c.config=r,typeof r.floatingTrigger=="object"&&(r.floatingTrigger.position!==void 0&&(c.position=r.floatingTrigger.position),r.floatingTrigger.label!==void 0&&(c.label=r.floatingTrigger.label)),t&&c.setAttribute("mode","light"),document.body.appendChild(c),l=()=>{o.open=!0},c.addEventListener("simplecmp:trigger-click",l)),e.applyConsents(),{show(){o.open=!0},hide(){o.open=!1},destroy(){e.unwatch(a),document.removeEventListener("simplecmp:configure",s),i?.remove(),o.remove(),c!==void 0&&l!==void 0&&(c.removeEventListener("simplecmp:trigger-click",l),c.remove())},manager:e}}var Ui=`:where(
    simplecmp-banner,
    simplecmp-modal,
    simplecmp-purpose-group,
    simplecmp-service-toggle,
...
`;var ut="data-simplecmp-theme",Fi={bootstrap5:Ui,tailwind4:qi,bulma:Bi,pico:Hi};function Vi(r){if(typeof document>"u")return;let e=document.querySelector(`style[${ut}]`);if(r===void 0||r==="default"){e?.remove();return}let t=Fi[r];if(t===void 0){console.warn(`SimpleCMP: theme "${r}" has no adapter; ignoring. Known themes: ${Object.keys(Fi).join(", ")}, 'default'.`);return}if(e?.getAttribute(ut)===r)return;let i=e instanceof HTMLStyleElement?e:document.createElement("style");i.setAttribute(ut,r),i.textContent=t,i.isConnected||document.head.appendChild(i)}function Br(r){return St(r)}function Hr(r){return _t(r)}function qr(r){return Le(r)}z(Ze,V(fi));var Fr="0.0.1",X=null,q=null,F=null;function Vr(r){ro(r),oo(r);let e=io(),t=e?{...r,testing:!0}:r;e&&no(),X!==null&&(X.destroy(),X=null),q!==null&&(q(),q=null),F!==null&&(F(),F=null),Vi(r.theme);let i=re(t);t.record&&Zr(t),t.interceptRuntime&&(q=Wr(t,i)),t.consentMode&&(F=Qe(t.consentMode,i,t.services));let n=null,o=[],s=()=>{n=Ii(t);for(let c of o)c==="show"?n.show():n.hide();o.length=0},a=null;return typeof document<"u"&&document.body!==null?s():typeof document<"u"&&(a=s,document.addEventListener("DOMContentLoaded",a,{once:!0})),X={show:()=>{n!==null?n.show():o.push("show")},hide:()=>{n!==null?n.hide():o.push("hide")},manager:i,destroy:()=>{q!==null&&(q(),q=null),F!==null&&(F(),F=null),a!==null&&typeof document<"u"&&(document.removeEventListener("DOMContentLoaded",a),a=null),n?.destroy(),n=null,o.length=0}},X}function Wr(r,e){let t=typeof r.interceptRuntime=="object"&&r.interceptRuntime!==null?r.interceptRuntime:{},i=vi(r.services,{blockAllUnknown:t.universalBlock===!0}),n=t.onBlock;return gi({matcher:i,consentChecker:o=>e.getConsent(o),sameOriginHosts:t.sameOriginHosts,onBlock:o=>{j!==null&&j.recordSyntheticDetection({kind:Kr(o.mechanism),identifier:o.url,origin:Gr(o.url)}),n?.(o)}})}function Kr(r){switch(r){case"script-src":return"script";case"iframe-src":return"iframe";case"img-src":return"image";case"fetch":case"xhr":case"sendBeacon":return"request"}}function Gr(r){try{return new URL(r,window.location.href).hostname||void 0}catch{return}}function Qr(){X?.show()}var j=null;function Zr(r){j&&(j.stop(),j=null);let e=typeof r.record=="object"&&r.record!==null?{...r.record}:{};if(!e.storageName&&typeof r.storageName=="string"&&(e.storageName=r.storageName),e.storageName){let s=e.ignoreCookies??[];e.ignoreCookies=s.includes(e.storageName)?s:[e.storageName,...s]}let t=r.services??[],i=r.serviceDbUrl?new G(new K({url:r.serviceDbUrl,auth:r.serviceDbAuth}),t):null,n=i??new W(t),o=new Ce({options:e,classifier:n,services:t,watcherFactories:[s=>new xe(s,{intervalMs:e.cookieIntervalMs}),s=>new Ee(s),s=>new ze(s)],onDetectionForLibEvent:s=>{Je("recorderDetection",s)}});if(i&&i.onEnrichment((s,a)=>{o.enrichDetection(s,a)}),r.cmsBridgeUrl){let s=to(),a=new L({url:r.cmsBridgeUrl,auth:r.cmsBridgeAuth,source:r.cmsBridge?.source??e.storageName??"default",dedupTtlMs:r.cmsBridge?.dedupTtlMs,crossSessionDedupMs:s?0:r.cmsBridge?.crossSessionDedupMs,flushDebounceMs:r.cmsBridge?.flushDebounceMs,maxBatchSize:r.cmsBridge?.maxBatchSize,sampleRate:s?1:r.cmsBridge?.sampleRate,respectDoNotTrack:s?!1:r.cmsBridge?.respectDoNotTrack,timeoutMs:r.cmsBridge?.timeoutMs,reportGeneration:r.cmsBridge?.reportGeneration});o.on("detectionSettled",c=>a.onDetection(c))}j=o,j.start()}function Jr(){return j??void 0}var Xr=Ut,Yr=re,eo=ie;function to(){if(typeof window>"u"||typeof URLSearchParams>"u")return!1;try{return new URLSearchParams(window.location.search).get("simplecmp_discover")==="1"}catch{return!1}}function io(){if(typeof window>"u"||typeof URLSearchParams>"u")return!1;try{if(new URLSearchParams(window.location.search).get("simplecmp_audit")==="1")return!0;let e=window.location.hash;return e.length>1&&new URLSearchParams(e.slice(1)).get("simplecmp_audit")==="1"}catch{return!1}}function no(){typeof window>"u"||requestAnimationFrame(()=>{requestAnimationFrame(()=>{requestAnimationFrame(()=>{let r=Le();try{window.parent.postMessage({type:"simplecmp-audit-from-fe",results:r,location:{href:window.location.href,host:window.location.host}},"*")}catch{}})})})}function ro(r){r.cmsBridgeUrl&&!r.record&&console.warn("SimpleCMP: `cmsBridgeUrl` is set but `record` is not enabled. The CMS bridge listens to recorder detections \u2014 without the recorder running, no webhooks will ever fire. Set `record: true` or remove `cmsBridgeUrl`.")}function oo(r){r.hideDeclineAll&&console.warn('SimpleCMP: `hideDeclineAll: true` hides the "Decline all" button on the first banner level. This is incompatible with German consent requirements (BGH "Cookie II", BGH I ZR 7/16; DSK 2022). Keep the decline option equally prominent or expect compliance issues.')}return Ji(so);})();
