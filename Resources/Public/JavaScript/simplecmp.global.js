...
`;function _r(r,e){if(r!==void 0){if(typeof r=="string")return r;if(typeof r=="object")return r[e]??r.default}}var T=class extends b{constructor(){super(...arguments);this.testing=!1;this._handleAccept=()=>{this.manager!==void 0&&(this.manager.changeAll(!0),this.manager.saveAndApplyConsents("accept"),this._emit("accept"))};this._handleDecline=()=>{this.manager!==void 0&&(this.manager.changeAll(!1),this.manager.saveAndApplyConsents("decline"),this._emit("decline"))};this._handleConfigure=t=>{t.preventDefault(),this._emit("configure")}}connectedCallback(){super.connectedCallback(),this.config?.autoFocus===!0&&queueMicrotask(()=>this.focus())}render(){let t=this.config,i=this.manager;if(t===void 0||i===void 0)return p;if(!this.testing&&i.confirmed)return p;if(t.noNotice===!0)return p;let n=i.bannerMode==="notice",o=this._activeLang(),s=this._resolvePolicyUrl(t.privacyPolicy,["privacyPolicyUrl"],o),a=this._resolvePolicyUrl(t.imprint,["imprintUrl"],o),c=this._t(["!","consentNotice","title"]),l=t.showNoticeTitle===!0&&c!==void 0,f=t.htmlTexts===!0,m=s?d`<a href=${s}>${this._t(["privacyPolicy","name"])}</a>`:"",u=a?d`<a href=${a}>${this._imprintLinkText()}</a>`:"",g=d`<a
    ...
    `}_renderNoticeButtons(t){let i=this._resolveLayout(t),n=t.hideLearnMore!==!0;return d`<div class="cn-buttons cn-layout-${i}">
      ${n?d`<button
            type="button"
            class="cn-configure"
            @click=${this._handleConfigure}
    ...
    </div>`}_renderButtonRow(t){let i=this._resolveLayout(t),n=i!=="compact"&&t.hideLearnMore!==!0,o=t.hideDeclineAll!==!0;return d`<div class="cn-buttons cn-layout-${i}">
      ${n?d`<button
            type="button"
            class="cn-configure"
            @click=${this._handleConfigure}
    ...
    `}_renderBody(t){let i=[],n=(o,s,a=!1)=>{if(s===void 0||s==="")return;let c=this._tString(["providerInfo","field",o])||o,l=a&&ge(s)?d`<a href=${s} target="_blank" rel="noopener noreferrer">${s}</a>`:d`${s}`;i.push(d`<dt>${c}</dt><dd>${l}</dd>`)};return n("vendor",t.vendor),n("description",t.vendorDescription),n("address",t.vendorAddress),n("country",t.vendorCountry),n("privacyPolicy",t.privacyPolicyUrl,!0),n("optOut",t.vendorOptOutUrl,!0),n("partner",t.vendorPartner),i.length===0?d`<p class="empty">
      ...
      </p>`:d`<dl>${i}</dl>`}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};D.styles=[w,y`
      :host {
        display: contents;
      }
    ...
    `}_renderPurposes(t){let i=t.purposes??[];if(i.length===0)return p;let n=i.map(s=>this._tString(["!","purposes",s,"title?"])||C(s)).join(", "),o=this._t(["service",i.length>1?"purposes":"purpose"]);return d`<p class="purposes">${o}: ${n}</p>`}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};H.styles=[he,y`
      :host {
        display: block;
    ...
    `],h([v({type:Boolean,reflect:!0})],S.prototype,"open",2),h([v({type:Boolean})],S.prototype,"testing",2),h([Re("dialog")],S.prototype,"_dialog",2),S=h([k("simplecmp-modal")],S);function Cr(r){return typeof r=="string"?Z(r):Array.isArray(r)?r.map(e=>typeof e=="string"?Z(e):e):r}var z=class extends b{constructor(){super(...arguments);this.position="bottom-right";this._onClick=t=>{t.preventDefault(),this._emit("trigger-click")}}connectedCallback(){super.connectedCallback(),this.setAttribute("position",this.position)}render(){let t=this._resolveLabel();return d`
    ...
    `}_resolveLabel(){if(this.label!==void 0&&this.label!=="")return this.label;if(this.config!==void 0){let t=this._tString(["!","floatingTrigger","label"]);if(t!=="")return t;if(ye(this.config.region,this.config.regimes,this.config.regimeDefault)==="opt-out"){let n=this._tString(["!","doNotSell"]);if(n!=="")return n}}return"Cookie settings"}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};z.styles=[w,y`
      :host {
        display: contents;
      }
    ...
    `],h([v({type:String})],z.prototype,"position",2),h([v({type:String})],z.prototype,"label",2),z=h([k("simplecmp-trigger")],z);function ji(r){let e=ne(r),t=r.domMode==="light",i;r.noNotice!==!0&&e.bannerMode!=="none"&&(!e.confirmed||r.testing===!0)&&(i=new T,i.config=r,i.manager=e,r.testing===!0&&(i.testing=!0),t&&i.setAttribute("mode","light"),document.body.appendChild(i));let o=new S;o.config=r,o.manager=e,r.testing===!0&&(o.testing=!0),t&&o.setAttribute("mode","light"),document.body.appendChild(o),r.mustConsent===!0&&!e.confirmed&&(o.open=!0);let s=()=>{o.open=!0};document.addEventListener("simplecmp:configure",s);let a={update(f,m){m==="saveConsents"&&i!==void 0&&(i.remove(),i=void 0)}};e.watch(a);let c,l;return r.floatingTrigger&&(c=new z,c.config=r,typeof r.floatingTrigger=="object"&&(r.floatingTrigger.position!==void 0&&(c.position=r.floatingTrigger.position),r.floatingTrigger.label!==void 0&&(c.label=r.floatingTrigger.label)),t&&c.setAttribute("mode","light"),document.body.appendChild(c),l=()=>{o.open=!0},c.addEventListener("simplecmp:trigger-click",l)),e.applyConsents(),{show(){o.open=!0},hide(){o.open=!1},destroy(){e.unwatch(a),document.removeEventListener("simplecmp:configure",s),i?.remove(),o.remove(),c!==void 0&&l!==void 0&&(c.removeEventListener("simplecmp:trigger-click",l),c.remove())},manager:e}}var Li=`:where(
    simplecmp-banner,
    simplecmp-modal,
    simplecmp-purpose-group,
    simplecmp-service-toggle,
