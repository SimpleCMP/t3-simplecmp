...
`;function Dn(r,e){if(r!==void 0){if(typeof r=="string")return r;if(typeof r=="object")return r[e]??r.default}}var P=class extends y{constructor(){super(...arguments);this.testing=!1;this._handleAccept=()=>{this.manager!==void 0&&(this.manager.changeAll(!0),this.manager.saveAndApplyConsents("accept"),this._emit("accept"))};this._handleDecline=()=>{this.manager!==void 0&&(this.manager.changeAll(!1),this.manager.saveAndApplyConsents("decline"),this._emit("decline"))};this._handleConfigure=t=>{t.preventDefault(),this._emit("configure")}}connectedCallback(){super.connectedCallback(),this.config?.autoFocus===!0&&queueMicrotask(()=>this.focus())}render(){let t=this.config,i=this.manager;if(t===void 0||i===void 0)return l;if(!this.testing&&i.confirmed)return l;if(t.noNotice===!0)return l;let n=this._activeLang(),o=this._resolvePolicyUrl(t.privacyPolicy,["privacyPolicyUrl"],n),s=this._resolvePolicyUrl(t.imprint,["imprintUrl"],n),a=this._t(["!","consentNotice","title"]),c=t.showNoticeTitle===!0&&a!==void 0,p=t.htmlTexts===!0,f=o?d`<a href=${o}>${this._t(["privacyPolicy","name"])}</a>`:"",m=s?d`<a href=${s}>${this._imprintLinkText()}</a>`:"",u=d`<a
    ...
    >`,v=this._t(["consentNotice","description"],{purposes:d`<strong>${this._purposesText(t)}</strong>`,privacyPolicy:f,imprint:m,learnMoreLink:u});return d`
      ...
      >
        ...
        <p id="cn-description">${p?Tn(v):v}</p>
    ...
    `}_activeLang(){return this.config?.lang??document.documentElement.lang??"en"}_collectFocusable(){let t=this._dialog;if(t===void 0)return[];let i=[],n='button:not([disabled]), a[href], input:not([disabled]):not([type="hidden"]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',o=s=>{if(s.matches(n)&&this._isVisible(s)&&i.push(s),s.shadowRoot!==null)for(let a of s.shadowRoot.children)o(a);for(let a of s.children)o(a)};for(let s of t.children)o(s);return i}_deepActiveElement(){let t=document.activeElement;for(;t?.shadowRoot?.activeElement;)t=t.shadowRoot.activeElement;return t}_isVisible(t){let i=t;return typeof i.checkVisibility=="function"?i.checkVisibility():t.offsetParent!==null}_collectPurposes(){let t=new Map;for(let i of this.config?.services??[])for(let n of i.purposes??[]){let o=t.get(n)??[];o.push(i),t.set(n,o)}return t}_resolvePolicyUrl(t,i,n){let o=On(t,n);if(o!==void 0)return o;let s=this._tString(["!",...i]);return s===""?void 0:s}_imprintLinkText(){return this._tString(["!","consentNotice","imprint","name"])||this._tString(["!","imprint","name"])||"Imprint"}_tString(t){let i=this._t(t);return typeof i=="string"?i:Array.isArray(i)?i.map(n=>typeof n=="string"?n:"").join(""):""}};S.styles=[w,b`
      :host {
        display: contents;
      }
    ...
    `],h([g({type:Boolean,reflect:!0})],S.prototype,"open",2),h([g({type:Boolean})],S.prototype,"testing",2),h([Pe("dialog")],S.prototype,"_dialog",2),S=h([k("simplecmp-modal")],S);function Rn(r){return typeof r=="string"?G(r):Array.isArray(r)?r.map(e=>typeof e=="string"?G(e):e):r}var C=class extends y{constructor(){super(...arguments);this.position="bottom-right";this._onClick=t=>{t.preventDefault(),this._emit("trigger-click")}}connectedCallback(){super.connectedCallback(),this.setAttribute("position",this.position)}render(){let t=this._resolveLabel();return d`
    ...
    `],h([g({type:String})],C.prototype,"position",2),h([g({type:String})],C.prototype,"label",2),C=h([k("simplecmp-trigger")],C);function fi(r){let e=ne(r),t=r.domMode==="light",i;r.noNotice!==!0&&(!e.confirmed||r.testing===!0)&&(i=new P,i.config=r,i.manager=e,r.testing===!0&&(i.testing=!0),t&&i.setAttribute("mode","light"),document.body.appendChild(i));let o=new S;o.config=r,o.manager=e,r.testing===!0&&(o.testing=!0),t&&o.setAttribute("mode","light"),document.body.appendChild(o),r.mustConsent===!0&&!e.confirmed&&(o.open=!0);let s=()=>{o.open=!0};document.addEventListener("simplecmp:configure",s);let a={update(f,m){m==="saveConsents"&&i!==void 0&&(i.remove(),i=void 0)}};e.watch(a);let c,p;return r.floatingTrigger&&(c=new C,c.config=r,typeof r.floatingTrigger=="object"&&(r.floatingTrigger.position!==void 0&&(c.position=r.floatingTrigger.position),r.floatingTrigger.label!==void 0&&(c.label=r.floatingTrigger.label)),t&&c.setAttribute("mode","light"),document.body.appendChild(c),p=()=>{o.open=!0},c.addEventListener("simplecmp:trigger-click",p)),e.applyConsents(),{show(){o.open=!0},hide(){o.open=!1},destroy(){e.unwatch(a),document.removeEventListener("simplecmp:configure",s),i?.remove(),o.remove(),c!==void 0&&p!==void 0&&(c.removeEventListener("simplecmp:trigger-click",p),c.remove())},manager:e}}var hi=`:where(
    simplecmp-banner,
    simplecmp-modal,
    simplecmp-purpose-group,
    simplecmp-service-toggle,
...
}`;var it="data-simplecmp-theme",gi={bootstrap5:hi};function vi(r){if(typeof document>"u")return;let e=document.querySelector(`style[${it}]`);if(r===void 0||r==="default"){e?.remove();return}let t=gi[r];if(t===void 0){console.warn(`SimpleCMP: theme "${r}" has no adapter; ignoring. Known themes: ${Object.keys(gi).join(", ")}, 'default'.`);return}if(e?.getAttribute(it)===r)return;let i=e instanceof HTMLStyleElement?e:document.createElement("style");i.setAttribute(it,r),i.textContent=t,i.isConnected||document.head.appendChild(i)}$(Be,V(qt));var Ln="0.0.1",J=null,H=null;function jn(r){Qn(r),Zn(r),J!==null&&(J.destroy(),J=null),H!==null&&(H(),H=null),vi(r.theme);let e=ne(r);r.record&&Hn(r),r.interceptRuntime&&(H=In(r,e));let t=null,i=[],n=()=>{t=fi(r);for(let s of i)s==="show"?t.show():t.hide();i.length=0},o=null;return typeof document<"u"&&document.body!==null?n():typeof document<"u"&&(o=n,document.addEventListener("DOMContentLoaded",o,{once:!0})),J={show:()=>{t!==null?t.show():i.push("show")},hide:()=>{t!==null?t.hide():i.push("hide")},manager:e,destroy:()=>{H!==null&&(H(),H=null),o!==null&&typeof document<"u"&&(document.removeEventListener("DOMContentLoaded",o),o=null),t?.destroy(),t=null,i.length=0}},J}function In(r,e){let t=typeof r.interceptRuntime=="object"&&r.interceptRuntime!==null?r.interceptRuntime:{},i=Kt(r.services,{blockAllUnknown:t.universalBlock===!0}),n=t.onBlock;return Ft({matcher:i,consentChecker:o=>e.getConsent(o),sameOriginHosts:t.sameOriginHosts,onBlock:o=>{R!==null&&R.recordSyntheticDetection({kind:Nn(o.mechanism),identifier:o.url,origin:Bn(o.url)}),n?.(o)}})}function Nn(r){switch(r){case"script-src":return"script";case"iframe-src":return"iframe";case"img-src":return"image";case"fetch":case"xhr":case"sendBeacon":return"request"}}function Bn(r){try{return new URL(r,window.location.href).hostname||void 0}catch{return}}function Un(){J?.show()}var R=null;function Hn(r){R&&(R.stop(),R=null);let e=typeof r.record=="object"&&r.record!==null?{...r.record}:{};if(!e.storageName&&typeof r.storageName=="string"&&(e.storageName=r.storageName),e.storageName){let s=e.ignoreCookies??[];e.ignoreCookies=s.includes(e.storageName)?s:[e.storageName,...s]}let t=r.services??[],i=r.serviceDbUrl?new W(new K({url:r.serviceDbUrl,auth:r.serviceDbAuth}),t):null,n=i??new F(t),o=new we({options:e,classifier:n,services:t,watcherFactories:[s=>new Se(s,{intervalMs:e.cookieIntervalMs}),s=>new _e(s),s=>new Ae(s)],onDetectionForLibEvent:s=>{Ue("recorderDetection",s)}});if(i&&i.onEnrichment((s,a)=>{o.enrichDetection(s,a)}),r.cmsBridgeUrl){let s=Wn(),a=new L({url:r.cmsBridgeUrl,auth:r.cmsBridgeAuth,source:r.cmsBridge?.source??e.storageName??"default",dedupTtlMs:r.cmsBridge?.dedupTtlMs,crossSessionDedupMs:s?0:r.cmsBridge?.crossSessionDedupMs,flushDebounceMs:r.cmsBridge?.flushDebounceMs,maxBatchSize:r.cmsBridge?.maxBatchSize,sampleRate:s?1:r.cmsBridge?.sampleRate,respectDoNotTrack:s?!1:r.cmsBridge?.respectDoNotTrack,timeoutMs:r.cmsBridge?.timeoutMs});o.on("detectionSettled",c=>a.onDetection(c))}R=o,R.start()}function qn(){return R??void 0}var Vn=ht,Fn=ne,Kn=te;function Wn(){if(typeof window>"u"||typeof URLSearchParams>"u")return!1;try{return new URLSearchParams(window.location.search).get("simplecmp_discover")==="1"}catch{return!1}}function Qn(r){r.cmsBridgeUrl&&!r.record&&console.warn("SimpleCMP: `cmsBridgeUrl` is set but `record` is not enabled. The CMS bridge listens to recorder detections \u2014 without the recorder running, no webhooks will ever fire. Set `record: true` or remove `cmsBridgeUrl`.")}function Zn(r){r.hideDeclineAll&&console.warn('SimpleCMP: `hideDeclineAll: true` hides the "Decline all" button on the first banner level. This is incompatible with German consent requirements (BGH "Cookie II", BGH I ZR 7/16; DSK 2022). Keep the decline option equally prominent or expect compliance issues.')}return _i(Gn);})();
